...
|---------|-------|-------|-------------|
| **Session 1** | `system-prompts/network-troubleshooter.md` | System prompts | [OpenAI — System Messages](https://developers.openai.com/api/docs/guides/text#message-roles-and-instruction-following) |
