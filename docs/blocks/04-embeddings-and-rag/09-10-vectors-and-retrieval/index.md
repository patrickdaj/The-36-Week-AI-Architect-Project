# 🧠 Block 9–10: Vectors & Retrieval

[← Block 7–8: Structured Output](../../03-llm-apis/07-08-structured-output/index.md) | [Block 11–12: Advanced RAG →](../11-12-advanced-rag/index.md)

> *"An embedding is just a list of numbers that captures meaning. Similar meanings = nearby numbers. That's it."*

**Quick Reference:** [→ Block 9–10 Quick Ref](quick-ref.md)
...
### ⏰ Service 6: RAG Demo for a Colleague
