# 🔬 Block 11: Infrastructure Audit Swarm Capstone

[← Block 10: SOC Analyst Agent](../10-soc-analyst-agent/index.md) | [Block 12: Running Local →](../../06-local-models/12-running-local/index.md)

> *"Three agents reviewing a network config catch things one agent misses. That's the whole point."*

**Quick Reference:** [→ Block 11 Quick Ref](quick-ref.md)
...
Build with LangGraph or CrewAI (your choice based on Block 9 comparison):
...
### ⏰ Project 12: Audit Report Delivery
