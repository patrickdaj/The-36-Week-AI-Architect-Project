# 🤖 Block 14–15: Tool Use & ReAct

[← Block 13: CVE Impact Analyzer](../../04-embeddings-and-rag/13-cve-impact-analyzer/index.md) | [Block 16–17: Multi-Agent Systems →](../16-17-multi-agent-systems/index.md)

> *"An agent is an LLM in a loop: think, act, observe, repeat. The magic is in knowing when to stop."*

**Quick Reference:** [→ Block 14–15 Quick Ref](quick-ref.md)
...
### ⏰ Service 9: Agent Failure Post-Mortem
