# 🤖 Block 16–17: Multi-Agent Systems

[← Block 14–15: Tool Use & ReAct](../14-15-tool-use-and-react/index.md) | [Block 18–19: SOC Analyst Agent →](../18-19-soc-analyst-agent/index.md)

> *"One agent is a tool. Multiple agents talking to each other is an architecture."*

**Quick Reference:** [→ Block 16–17 Quick Ref](quick-ref.md)
...
### ⏰ Service 10: Live Agent Comparison
