# 🔌 Block 3: Your First AI Apps

[← Block 2: Data & Tooling](../../02-python-for-ai/02-data-and-tooling/index.md) | [Block 4: Structured Output →](../04-structured-output/index.md)

> *"Most AI apps are API wrappers with good prompts. That's not an insult — it's a superpower if you do it right."*

**Quick Reference:** [→ Block 3 Quick Ref](quick-ref.md)
...
### ⏰ Project 4: Dog-Food Your Troubleshooter
